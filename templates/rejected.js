        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:580px;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#8B0000 0%,#B22222 100%);border-radius:12px 12px 0 0;padding:36px 40px;text-align:center;">
              <img src="https://res.cloudinary.com/dtox39f5c/image/upload/v1783114333/logo_oulat3.jpg" alt="JEEsociety" width="80" height="80" style="display:block;margin:0 auto 16px;border-radius:16px;border:0;" />
